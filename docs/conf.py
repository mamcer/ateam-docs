...
if not on_rtd:
    ...
    feed_base_url = 'https://github.com/mamcer/sphinx-docs'
    feed_description = 'ATeam Documentation'
    feed_author = 'ATeam'
...
latex_documents = [
  ('index', 'ateamdocs.tex', 'ATeam Documentation',
   'ATeam', 'manual'),
]
...
man_pages = [
    ('index', 'ateamdocs', 'ATeam Documentation',
     ['ATeam'], 1)
]
...
texinfo_documents = [
  ('index', 'ateamdocs', 'ATeam Documentation',
   'ATeam', 'ateamdocs', 'ATeam Documentation',
   'Development'),
]
